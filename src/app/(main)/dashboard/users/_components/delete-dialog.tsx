    ...
    return (
        <AlertDialog open={open} onOpenChange={setOpen}>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>
                        Delete {type === "role" ? "Role" : "Permission"}?
                    </AlertDialogTitle>
                    <AlertDialogDescription>
                ...
                {affectedCount > 0 && (
                    <Alert variant="destructive">
                        ...
                        <AlertDescription>
                            {type === "role" ? (
                                <>
                                    This role is currently assigned to <strong>{affectedCount} user(s)</strong>.
                                    Deleting it will remove these assignments.
                                </>
                            ) : (
                                <>
                                    This permission is used by <strong>{affectedCount} role(s)</strong>.
                                    Deleting it will remove it from those roles.
                                </>
                            )}
                        </AlertDescription>
                    </Alert>
