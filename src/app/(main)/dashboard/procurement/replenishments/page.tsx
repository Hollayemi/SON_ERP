    ...
    const filteredData = useMemo(
        () =>
            replenishments.filter((replenishment) => {
                const matchesSearch =
                    searchQuery === "" ||
                    replenishment.item_name.toLowerCase().includes(searchQuery.toLowerCase());
            ...
            },
            {
                ...
                cell: ({ row }) => {
                    ...
                    const statusConfig: Record<string, { color: string; icon: any }> = {
                        ...
                        in_procurement: { color: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400", icon: ShoppingCart },
    ...
    return (
        <div className="@container/main flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-semibold tracking-tight">Stock Replenishment</h1>
