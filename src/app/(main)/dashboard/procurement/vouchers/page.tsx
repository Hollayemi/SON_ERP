    ...
    const filteredData = useMemo(
        () =>
            vouchers.filter((voucher) => {
                const matchesSearch =
                    searchQuery === "" ||
                    voucher.srv_number.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return (
        <div className="@container/main flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-semibold tracking-tight">Store Receive Vouchers (SRV)</h1>
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-muted-foreground text-sm">
                        ...
                        issued. The SRV, along with other procurement documents (Award Letter, Invoice, Purchase Order), is then sent
                        to the Director General for approval before proceeding to Finance for payment processing.
                    </p>
                </CardContent>
            </Card>
