                  ...
                  {selectedRequest && (
                    <div className="bg-muted rounded-lg p-4">
                      ...
                      <div className="space-y-1 text-sm">
                        <p>
                          <span className="text-muted-foreground">Item:</span> {selectedRequest.itemName}
                        </p>
                        <p>
                          <span className="text-muted-foreground">Quantity:</span> {selectedRequest.quantity}
                        </p>
                        <p>
                          <span className="text-muted-foreground">Department:</span> {selectedRequest.department}
                        </p>
                      </div>
                    </div>
                  )}
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Calendar className="text-muted-foreground pointer-events-none absolute top-3 right-3 size-4" />
                          </div>
                        </FormControl>
                        <FormMessage />
                      </FormItem>
