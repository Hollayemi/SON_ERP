    ...
    const columns: ColumnDef<PurchaseOrder>[] = [
        {
            ...
            header: ({ column }: { column: Column<PurchaseOrder> }) => <DataTableColumnHeader column={column} title="PO Number" />,
            cell: ({ row }) => <div className="font-medium font-mono">{row.getValue("poNumber")}</div>,
        },
        {
        ...
        },
        {
            ...
            cell: ({ row }) => (
                <div className="flex gap-2">
                    <Button size="sm" variant="ghost" onClick={() => router.push(`/dashboard/procurement/purchase-orders/${row.original.id}`)}>
